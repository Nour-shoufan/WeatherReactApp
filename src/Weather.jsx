...
setIsDay(data.current_weather.is_day);
  ...
  return (
    <div className="border" style={{display:'flex', justifyContent:'center', alignItems:'center',marginTop:'2%'}}>

       <div style={{backgroundColor:'rgba(255, 255, 255, 0.5)' ,width:'350px',height:'450px',padding:'20px'}}>
       <h1 style={{margin:'0px'}} >Today Weather</h1>
  
    <div className="time"  style={{display:'flex',backgroundColor:'#71ce71ff',justifyContent:'space-around',marginTop:"10px"}}>
          <h6 style={{padding:'12px',color:'white',marginBottom:'0px',fontSize:'14px',margin:'5px'}}>
        {hour}
        {isDay=='1'?' am':' bm'}
        </h6>
    ...
    {time}
       ...
       <div className="sid" style={{display:'flex',justifyContent:'space-around'}}>
        <img src={image} style={{  width:'200px',margin:'0px' }}  />
               <div className="flex">
                   <p style={{marginTop:'30px'}}>Temperature</p>
        <h1  style={{fontSize:'45px',margin:'0px'}}> 20
          {temp}
          °C</h1>
               </div>
         ...
         <div className="f" style={{display:'flex',justifyContent:'space-around',marginTop:'20px'}}>
               <div className="icons" style={ {display:'flex', justifyContent:'space-around', backgroundColor:'gray',fontSize:'20px',width:'100px',height:'50px'}}>
...
>
  <path d="M12 2C12 2 6 9 6 14a6 6 0 0 0 12 0c0-5-6-12-6-12z" />
        ...
        <div className="ico" style={ {display:'flex', justifyContent:'space-around', backgroundColor:'gray',fontSize:'20px',width:'100px',height:'50px'}}>
          <svg
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="50"
